...
- [代码库 API](/legacy/api/code-library)
...
- [规则管理](/legacy/api/rules)
- [动作管理](/legacy/api/actions)
- [设备管理](/legacy/api/devices)
- [全局变量](/legacy/api/variables)
- [代码库](/legacy/api/code-library)
- [手势识别](/legacy/api/gestures)
- [系统集成](/legacy/api/system)

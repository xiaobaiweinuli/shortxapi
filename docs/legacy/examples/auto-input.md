...
- [基础示例](/legacy/examples/basic) - 学习基础用法
- [通知处理](/legacy/examples/notifications) - 更多通知处理示例

## 相关文档

- [MVEL 表达式](/legacy/guide/actions#mvel-执行) - 了解 MVEL 语法
- [动作执行](/legacy/guide/actions) - 学习动作使用
- [规则管理 API](/legacy/api/rules) - 查看完整 API
